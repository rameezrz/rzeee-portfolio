...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Muhammed Rameez.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="bg-white p-4 text-gray-700 flex items-center rounded-full text-[1.35rem] outline-none focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950  active:scale-105 transition border border-black/10 dark:bg-white/10 dark:text-white/60"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
